<?php
$_['lang_title'] = 'Nueva lista en Amazon US';
...
$_['button_amazonus_price'] = "Obtener el precio de Amazon US";
...
$_['text_product_not_sent'] = 'El producto no fue enviado a Amazon US. Razón: %s';
...
$_['error_amazonus_price'] = 'No se pudo obtener el precio desde Amazon';
...
$_['text_error_connecting'] = 'Cuidado: Hubo un problema conectando con Welford Media API servers. Por favor checa tus configuraciones de OpenBay Pro Amazon US. Si el problema continua, contacta con el soporte de Welford.';

/* Quick/advanced listing tabs */
$_['quick_listing_description'] = 'Usar este metodo cuando un producto que coincida ya existe en el catalogo de  Amazon US. Coincidencias son encontradas por Amazon US usando el ID Standard del producto(ASIN, ISBN, UPS, EAN)';
...
$_['new_link_amazonus_sku_column'] = 'SKU del artículo de AmazonAmazon';
...
$_['amazonus_sku_column_text'] = 'SKU del artículo de Amazon';
...
$_['links_desc1_text'] = 'Enlazando tus artículos permitira controlar el stock de tus listas en Amazon US.<br /> Por cada artículo que es actualizado el stock local (el stock disponible en tu tienda OpenCart) actualizara tus listas en Amazon US';
$_['links_desc2_text'] = 'Puesde enlezar artículos manualmente introduciendo el Amazon US SKU y el nombre del producto or cargar todos los productos que no estan enlazados y introducir los amazon us SKUs. (Subir producto de Opencart a Amazon US automaticamente agregara enlaces)';
