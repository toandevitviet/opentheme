...
$(function(){
	...
	$('.banners .s-desc, .top-banner .s-desc').each(function(){
		var title = $(this).html();
		$(this).addClass('custom_hover');
		$(this).html('<span class="out">'+title+'</span><span class="over">'+title+'</span>');
	})
	
	$('ul.sf-menu > li > a, .wishlist a, .compare a, .cart a.button, #button-filter.button, .product-compare a.button, a.button-prod').each(function(){
		var title = $(this).html();
...
/**********************************************************add icon aside li *****************************************************************************/
    $(document).ready(function(){
       ...
       $('aside').find('ul.info-list li>a').prepend('<i class="fa fa-caret-right"></i>');
	   $('aside').find('ul.afine li>a').prepend('<i class="fa fa-caret-right"></i>');
	   $('aside').find('ul.acount li>a').prepend('<i class="fa fa-caret-right"></i>');
    });
/******************************************************Aside box category**************************************************************************************/
$(document).ready(function(){
		jQuery('.box .box-category').find('li.parent').prepend('<i class="fa fa-chevron-circle-down"></i>');
		jQuery(this).find('ul a.active').closest('li.parent').find('> ul').slideToggle().closest('li.parent').find('>i').addClass('fa-caret-up');
