...
<?php echo $column_left; ?>
	...
	<div class="col-sm-8"><?php } else { ?><div class="col-sm-12"><?php } ?>
	  ...
	  <div class="cart">
		...
		<div class="review">
			<div>
				<img src="catalog/view/theme/theme483/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;
				<div class="btn-rew">
